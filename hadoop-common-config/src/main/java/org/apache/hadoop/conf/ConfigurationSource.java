...
public interface ConfigurationSource {
  ...
  default String[] getTrimmedStrings(String name, String def) {
    return null;
  }
   ...
   */
  default <U> Class<? extends U> getClass(
      String name,
  ...
  Map<String, String> getValByRegex(String usersGroupsRegEx);

  String[] getStringCollection(String credentialProviderPath);

  Class<?> getClassByName(String protocolName);

  <T> List<T> getInstances(String s, Class<T> costProviderClass);

  long[] getTimeDurations(String s, TimeUnit milliseconds);
}
